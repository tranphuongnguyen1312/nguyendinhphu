...
function Discord() {
  setTimeout(function() {
    window.open('https://dsc.bio/everwing1312', '_blank')},
  100);
}
function Instagram() {
  setTimeout(function() {
    window.open('https://instagram.com/dinh_phu03?utm_source=qr&igshid=ZDc4ODBmNjlmNQ%3D%3D', '_blank')},
  100);
}
